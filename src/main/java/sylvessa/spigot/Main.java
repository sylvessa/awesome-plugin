...
import sylvessa.spigot.Discord.Bot;
import sylvessa.spigot.Duels.DuelListener;
import sylvessa.spigot.Listeners.*;
import sylvessa.spigot.Minigames.MinigameListener;
import sylvessa.spigot.Teams.TeamManager;
import sylvessa.spigot.Types.PluginCommand;
import sylvessa.spigot.Types.TpaRequest;
...
public class Main extends JavaPlugin {
    ...
    private void autoRegisterCommands() throws Exception {
        ...
        try (JarFile jar = new JarFile(new File(jarURL.toURI()))) {
            ...
            while(entries.hasMoreElements()) {
                ...
                if(!name.startsWith("sylvessa/spigot/commands")) continue;
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new FlightSoupListener(), this);
