...
public final class ItemNBT {
    public static net.minecraft.server.ItemStack nms(ItemStack item) {
        net.minecraft.server.ItemStack nms =
                CraftItemStack.createNMSItemStack(item);
    ...
    public static ItemStack apply(net.minecraft.server.ItemStack nms) {
        return new CraftItemStack(nms);
    }
    ...
    public static ItemStack remove(ItemStack item, String key) {
        net.minecraft.server.ItemStack nms = nms(item);
        nms.tag.remove(key);
        return apply(nms);
    }
    ...
    public static ItemStack setCompound(ItemStack item, String key, net.minecraft.server.NBTTagCompound c) {
        net.minecraft.server.ItemStack nms = nms(item);
        nms.tag.setCompound(key, c);
        return apply(nms);
    }

    public static net.minecraft.server.NBTTagCompound getCompound(ItemStack item, String key) {
        net.minecraft.server.ItemStack nms =
                CraftItemStack.createNMSItemStack(item);
    ...
    public static ItemStack setList(ItemStack item, String key, net.minecraft.server.NBTTagList list) {
        net.minecraft.server.ItemStack nms = nms(item);
        nms.tag.set(key, list);
        return apply(nms);
    }

    public static net.minecraft.server.NBTTagList getList(ItemStack item, String key) {
        net.minecraft.server.ItemStack nms =
                CraftItemStack.createNMSItemStack(item);
